...
export RUN_ID="${RUN_ID:-matformer_small2_large4_p50_30m_1xh100_seed1337}"
export WANDB_NAME="${WANDB_NAME:-matformer_small2_large4_p50_30m_1xh100_seed1337}"
...
export LARGE_SAMPLE_PROB="${LARGE_SAMPLE_PROB:-0.5}"
