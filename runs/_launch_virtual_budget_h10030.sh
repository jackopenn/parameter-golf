...
export WANDB_GROUP="${WANDB_GROUP:-h10030_virtual_budget}"
export WANDB_TAGS="${WANDB_TAGS:-1xh100,30m,virtual-budget,factored}"
...
echo "  WANDB_PROJECT=${WANDB_PROJECT} WANDB_ENTITY=${WANDB_ENTITY} WANDB_GROUP=${WANDB_GROUP}"
