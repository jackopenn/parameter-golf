...
export RUN_ID="${RUN_ID:-branch_k1_t8_kd_consolidate_seed1337}"
export WANDB_NAME="${WANDB_NAME:-${RUN_ID}}"
export WANDB_TAGS="${WANDB_TAGS:-branch-tail,kd,consolidate,k1,t8,single-h100-30m}"

export SEED="${SEED:-1337}"
export BRANCH_TAIL_LAYERS="${BRANCH_TAIL_LAYERS:-1}"
